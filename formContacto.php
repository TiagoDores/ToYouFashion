        ...
        <section class="contact-section">
            <div class="container">
                <div class="d-none d-sm-block mb-5 pb-4">
                    ...
                    <script>
                        function initMap() {
                            ...
                            var map = new google.maps.Map(document.getElementById('map'), {
                                center: {
                                    lat: 40.513234272772806,
                                    lng: -8.492154754385396
                                },
                                zoom: 19,
                    ...
                    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAr_8qqsMK9XdMicu0uHSv4tGhFnnmJYBs&callback=initMap">
                    </script>
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="enviarEmail.php" method="post" id="contactForm" novalidate="novalidate">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control" name="assunto" id="assunto" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Assunto'" placeholder="Assunto">
                                    </div>
                                </div>
                            </div>
