...
<head>
    ...
    <title>To You Fashion | Contactos</title>
        ...
        <section class="contact-section">
            <div class="container">
                <div class="d-none d-sm-block mb-5 pb-4">
                    ...
                    <script
                        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAr_8qqsMK9XdMicu0uHSv4tGhFnnmJYBs&amp;callback=initMap">
                        </script>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="enviarEmail.php" method="post" id="contactForm"
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>Oliveira do Bairro, Portugal.</h3>
                                <p>Av. Drº Abílio Pereira Pinto</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                            <div class="media-body">
                                <h3>+351 912 934 110</h3>
                                <p>Segunda a Sexta das 09:00 ás 19:00</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                    ...
                    <div class="col-xl-5 col-lg-4 col-md-5">
                        <div class="footer-copy-right f-right">
                            ...
                            <div class="footer-social">
                                ...
                                <a href="https://www.facebook.com/toyoufashion"><i class="fab fa-facebook-f"></i></a>
